...
func CreateShip(instance_id : int, instance_owner : String, instance_chassis_type : String, instance_generator_type : String, instance_cargo_bay_type : String, instance_shield_generator_type : String, instance_engine_type : String):
